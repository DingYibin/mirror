...
@dataclass
class EnoughTransformerConfig(TransformerConfig):
    num_feature_extraction_layers: int = 0
    num_feature_expand_layers: int = 0
    num_decode_layers: int = 0

class OffsetTransformerBlock(TransformerBlock):
    pass
    def __init__(
        self,
    ...
    def _build_layers(self):
        ...
        self.layers = torch.nn.ModuleList(
            [
                build_layer(layer_spec, i + 1 + self.offset)
...
class EnoughGPTModel(LanguageModule):
