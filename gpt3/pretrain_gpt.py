...
"""
 ...
 8: remove self attn
 9: remove self attn after mtp 1
10: use softmax(logits) * embeddings as input, NUM_TRANSFORMER_BLOCK_ONE_MTP_LAYER
"""
...
print(f"MTP_EH_PROJ_MODE = {MTP_EH_PROJ_MODE}\n"
      f"NUM_TRANSFORMER_BLOCK_ONE_MTP_LAYER = {NUM_TRANSFORMER_BLOCK_ONE_MTP_LAYER}\n", end="")
assert MTP_EH_PROJ_MODE >= 0 and MTP_EH_PROJ_MODE <= 10, f"MTP_EH_PROJ_MODE = {MTP_EH_PROJ_MODE}, which should be an integer in [0, 9].\n"
